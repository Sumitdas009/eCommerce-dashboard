        ...
        <div class="container">
            ...
            <div class="col-md-9">
                ...
                <div class="box">
                    ...
                    <form method="post" action="product_request.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="p_desc" class="form-control" id="" cols="30" rows="10"></textarea>


                        </div>

                        <div class="text-center">
                            <button id="submit" type="submit" name="request" class="btn btn-primary">
...
<?php
 if(isset($_POST['request'])){ $p_name = $_POST['p_name']; $p_desc = $_POST['p_desc'];
        $product_request = "insert into product_request (p_name, p_desc) values ('$p_name','$p_desc')";
                $run_customer = mysqli_query($con,$product_request);
                echo "<script>alert('Your product request is sent.')</script>";
